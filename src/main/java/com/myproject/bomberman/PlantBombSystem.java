...
public class PlantBombSystem extends System {
    ...
    public void update(double tpf) {
        ...
        for (Entity entity : entityList) {
            ...
            int bombCapacity =  entity.getComponentByType(WalkInputComponent.class).getBOMB_CAPACITY();
            if (input.getBombCheck() == 1) {
                ...
                PlantBombAnimationComponent plantBombAnimationComponent = new PlantBombAnimationComponent("Bomb.png",entity.getComponentByType(WalkInputComponent.class).getFLAME_DURATION());
                ...
                FXGLForKtKt.getGameTimer().runOnceAfter(()->{
                    ...
                    }, Duration.seconds(entity.getComponentByType(WalkInputComponent.class).getFLAME_DURATION()));
                }, Duration.seconds(2));
            }
        }
    }
